...
#define CMT23_PKT1 0x38
#define CMT23_TX_PREAM_L 0x39
#define CMT23_TX_PREAM_H 0x3A
#define CMT23_PREAM_VALUE 0x3B
#define CMT23_SYNC_CTL 0x3C
#define CMT23_SYNC_ADDR_0 0x3D
#define CMT23_SYNC_ADDR_7 0x44
#define CMT23_PKT_CTRL1 0x45
#define CMT23_PKT_LEN 0x46
#define CMT23_NODE_CTL 0x47
#define CMT23_NODE_ADDR_0 0x48
#define CMT23_NODE_ADDR_1 0x49
#define CMT23_NODE_ADDR_2 0x4A
#define CMT23_NODE_ADDR_3 0x4B
...
#define CMT23_FREQ_CHNL 0x63
#define CMT23_FREQ_OFS 0x64
...
#define PREAM_UNIT_SET 0x04
#define SYNC_MAN_CODE 0x01
#define PKT_FORMAT 0x01
#define PKT_LSB_PRIO 0x02
#define NODE_POSITION 0x04
#define AUTO_ACK 0x08

#define NODE_DISABLE 0x00
#define NODE_ONLY 0x01
#define NODE_AND0 0x02
#define NODE_ALL 0x03
...
#define MODE_GO_EEPROM (1 << 0)
#define MODE_GO_STBY (1 << 1)
#define MODE_GO_RFS (1 << 2)
#define MODE_GO_RX (1 << 3)
#define MODE_GO_SLEEP (1 << 4)
#define MODE_GO_TFS (1 << 5)
#define MODE_GO_TX (1 << 6)
#define MODE_GO_SWITCH (1 << 7)

#define RSTN_IN_EN (1 << 5)
#define EEP_CPY_DIS (1 << 4)
...
#define SLEEP_TMO_EN (1 << 7)
#define RX_TMO_EN (1 << 6)
#define TX_DONE_EN (1 << 5)
#define PREAMBLE_PASS_EN (1 << 4)
#define SYNC_PASS_EN (1 << 3)
#define NODE_PASS_EN (1 << 2)
#define CRC_PASS_EN (1 << 1)
...
#define RX_FIFO_CLR_DIS (1 << 4)
#define TX_FIFO_RD_EN (1 << 3)
#define FIFO_RX_TX_SEL (1 << 2)
#define FIFO_SHARE_EN (1 << 1)
#define SPI_FIFO_RD_WR_SEL (1 << 0)

#define SLEEP_TIMEOUT_FLAG (1 << 5)
#define RX_TIMEOUT_FLAG (1 << 4)
#define TX_DONE_FLAG (1 << 3)
#define TX_DONE_CLR (1 << 2)
#define SLEEP_TIMEOUT_CLR (1 << 1)
#define RX_TIMEOUT_CLR (1 << 0)

#define LBD_CLR (1 << 5)
#define PREAMBLE_PASS_CLR (1 << 4)
#define SYNC_PASS_CLR (1 << 3)
#define NODE_PASS_CLR (1 << 2)
#define CRC_PASS_CLR (1 << 1)
#define RX_DONE_CLR (1 << 0)

#define FIFO_RESTORE (1 << 2)
#define FIFO_CLR_RX (1 << 1)
#define FIFO_CLR_TX (1 << 0)

#define LBD_STATUS_FLAG (1 << 7)
#define COLLISION_ERR_FLAG (1 << 6)
#define DC_ERR_FLAG (1 << 5)
#define PREAMBLE_PASS_FLAG (1 << 4)
#define SYNC_PASS_FLAG (1 << 3)
#define NODE_PASS_FLAG (1 << 2)
#define CRC_PASS_FLAG (1 << 1)
#define RX_DONE_FLAG (1 << 0)

#define RX_FIFO_FULL_FLAG (1 << 6)
#define RX_FIFO_NMTY_FLAG (1 << 5)
#define RX_FIFO_THRESH_FLAG (1 << 4)
#define RX_FIFO_OV_FLAG (1 << 3)
#define TX_FIFO_FULL_FLAG (1 << 2)
#define TX_FIFO_NMTY_FLAG (1 << 1)
#define TX_FIFO_THRESH_FLAG (1 << 0)

/* All functions are now static and defined in cmt2300a.c */
